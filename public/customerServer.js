...
initCustomerServer.prototype.init = function () {
  request(this.baseUrl + "/api/mobile/service/icon", "get", null, this.settingObj.token)
    .then((res) => {
